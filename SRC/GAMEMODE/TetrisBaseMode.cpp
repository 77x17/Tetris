...
TetrisBaseMode::TetrisBaseMode(sf::RenderWindow* win, Scene* s): window(win), scene(s){}

TetrisBaseMode::~TetrisBaseMode(){}

void TetrisBaseMode::loadPlayground(sf::Texture &backgroundTexture, sf::Sprite &backgroundSprite) {
